...
include('Header.php');
ob_start();
$selQry = "select * from tbl_user u inner join tbl_place p on u.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where u.user_id='".$_SESSION["uid"]."'";
...
?>
	...
	<div class="limiter">
        ...
        <div class="row-user-profile">
					<div ><img class="img-user-profile" src="../Assets/Files/User/<?php echo $data["user_photo"]?>" alt="<?php echo $data["user_photo"]?>" width="150px" height="150px" /></div>
	  			 </div>
          <div class="rowuser">
					<div >Name</div>
					<div class="inp"><?php echo $data["user_name"]?></div>
	  			 </div>
				   <div class="rowuser">
					<div>Contact</div>
					<div class="inp"><?php echo $data["user_contact"]?></div>
					</div>
					<div class="rowuser">
					<div>Email</div>
					<div class="inp"><?php echo $data["user_email"]?></div>
					</div>
					<div class="rowuser">
					<div>Address</div>
					<div class="inp"><?php echo $data["user_address"]?></div>
					</div>
          ...
          <div class="rowuser">
					<div class="inpu">&nbsp;&nbsp;<a href="EditProfile.php">Edit Profile</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ChangePassword.php">Change Password</a></div>
          </div>
