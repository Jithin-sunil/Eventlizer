...
<html lang="en" >
	...
	{
		$upQry = "update tbl_booking set booking_status='3' where booking_id='".$_GET["bid"]."'";
		if($con->query($upQry))
		{
			?>
            <script>
                    ...
                    <form method="post">
                        ...
                        <div class="card space icon-relative">
                         ...
                         <div class="card space icon-relative">
                            ...
                            <input type="text" class="input" readonly  placeholder="Amount " value="<?php echo $_GET["bamount"] ?>">
                            <i class="far fa-credit-card"></i>
                        </div>
