			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post">
                  <div class="rowuser">
					...
					<div ><input class="inp" type="password" name="txt_curr" id="txt_curr" required/></div>
	  			 </div>
				   <div class="rowuser">
					<div>New Password</div>
					<div><input class="inp" type="password" name="txt_new" id="txt_new" required/></div>
					</div>
					<div class="rowuser">
					<div>Confirm Password</div>
					<div><input class="inp" type="password" name="txt_confirm" id="txt_confirm" required/></div>
					</div>
