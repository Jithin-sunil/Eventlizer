...
if(isset($_POST["btn_save"]))
{
  ...
  $img=$_FILES["file_photo"]["name"];
	$temp=$_FILES["file_photo"]["tmp_name"];
	move_uploaded_file($temp,"../Assets/Files/User/".$img);

	$id=$_POST["txt_id"];
	if($id!="")
	{
		$upQry = "update tbl_complaint set complaint_title='".$title."',complaint_content='".$cont."',complaint_img='".$img."' where complaint_id='".$id."'";
		if($con->query($upQry))
		{
	...
	{
	$insQry="insert into tbl_complaint(complaint_title,complaint_content,complaint_date,user_id,complaint_img)values('".$title."','".$cont."',curdate(),'".$_SESSION["uid"]."','".$img."')";
		if($con -> query($insQry))
		{
			?>
			<script>
...
<table width="200" border="1" align="center">
  ...
  <tr>
    ...
    <td><img src="../Assets/Files/User/<?php echo $data["complaint_img"]?>" width="120px" height="120px" /></td>
