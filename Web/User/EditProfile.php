...
if(isset($_POST["btn_update"]))
{
  $name = $_POST["txt_name"];
	...
	$upQry="update tbl_user set user_name='".$name."',user_contact='".$contact."',user_email='".$email."',user_address='".$add."',user_photo='".$photo."' where user_id='".$_SESSION["uid"]."'";
	if($con->query($upQry))
	{
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" enctype="multipart/form-data">
				 ...
				 <div class="row-user-profile">
					 <div ><img class="img-user-profile" src="../Assets/Files/User/<?php echo $data["user_photo"]?>" alt="<?php echo $data["user_photo"]?>" width="140px" height="140px" />
