        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			 ...
			 $selQry = "select * from tbl_eventtype";
				 ...
				 $rs = $con->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "select COALESCE(count(booking_id),0) as num from tbl_booking b inner join tbl_package c on c.package_id=b.package_id inner join tbl_eventorganiser e on e.organiser_id=c.organiser_id where c.eventtype_id='".$data["eventtype_id"]."'";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["eventtype_name"]; ?></td>
                 <td align="center"><?php echo $data2["num"]; ?></td>
              </tr>
               <?php
				}
			?>
