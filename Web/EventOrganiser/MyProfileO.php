...
include("HeaderO.php");
ob_start();
$selQry = "select * from tbl_eventorganiser o inner join tbl_place p on o.place_id=p.place_id inner join tbl_district d on p.district_id=d.district_id where o.organiser_id='".$_SESSION["oid"]."'";
...
?>
	...
	<div class="limiter">
        ...
        <div class="row-user-profile">
					<div ><img class="img-user-profile" src="../Assets/Files/Events/<?php echo $data["organiser_photo"]?>" alt="<?php echo $data["organiser_photo"]?>" width="140px" height="140px" /></div>
	  			 </div>
          <div class="rowuser">
					<div  >Name</div>&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="inp"><?php echo $data["organiser_name"]?></div>
	  			 </div>
           <div class="rowuser">
					<div>Address</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="inp"><?php echo $data["organiser_address"]?></div>
					</div>
				   <div class="rowuser">
					<div>Contact</div>
					<div class="inp"><?php echo $data["organiser_contact"]?></div>
					</div>
					<div class="rowuser">
					<div>Email</div>
					<div class="inp"><?php echo $data["organiser_email"]?></div>
					</div>
					

          <div class="rowuser">
					<div>District</div>
					<div class="inp"><?php echo $data["district_name"]?></div>
					</div>
          <div class="rowuser">
					<div>Place</div>
					<div class="inp"><?php echo $data["place_name"]?></div>
					</div>
          <div class="rowuser">
					<div>License Number</div>
					<div class="inp"><?php echo $data["organiser_license"]?></div>
					</div>
          <div class="rowuser">
					<div>Details</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="inp"><?php echo $data["organiser_details"]?></div>
					</div><div class="rowuser">
					<div>User Name</div>
					<div class="inp"><?php echo $data["organiser_username"]?></div>
					</div><div class="rowuser">
					<div>Password</div>
					<div class="inp"><?php echo $data["organiser_password"]?></div>
					</div> 

          <div class="rowuser">&nbsp;
					<div class="inpu">&nbsp;&nbsp;<a href="EditProfileO.php">Edit Profile</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ChangePassO.php">Change Password</a></div>
          </div>
