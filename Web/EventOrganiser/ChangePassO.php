...
if(isset($_POST["btn_check"]))
{
	...
	if($current == $data['organiser_password'])
	{
	  if($new== $confirm)
	  {
	    $upQry="update tbl_eventorganiser set organiser_password='".$new."' where organiser_id='".$_SESSION["oid"]."'";
	    if($con->query($upQry))
	    {
	    ...
	    else
	  {
		  ?>
			...
			windows.location="ChangePassO.php";
			</script>
			<?php
	  }
	}
